...
export default function Footer() {
  ...
  return (
    <section id="footer" className="p-4">
      <footer
        ref={footerRef}
        className="flex flex-col justify-between gap-8 p-4 md:px-8 pt-8 pb-6 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A] h-[600px] lg:h-[clamp(700px,95vh,900px)]"
      >
        <div className="flex justify-between w-full">
          <p className="font-semibold text-[clamp(16px,1.6vw,24px)] text-[#FF0000]">
            San Francisco, CA
          </p>
        ...
        <div ref={matterContainer} className="h-full relative overflow-hidden">
          <h2 className="text-[clamp(50px,6vw,72px)] font-semibold text-center tracking-tight leading-[0.85] top-12 lg:top-0 left-1/2 -translate-x-1/2 absolute w-full text-white">
            Let&apos;s work{" "}
            <span className="text-[#FF0000] z-50">together!</span>
          </h2>
        ...
        <div className="flex items-end justify-between md:hidden">
          <ul className="flex flex-col gap-1 w-full">
            <li>
              ...
              >
                <p className="font-semibold text-[#E5E5E5] hover:text-[#FF0000] transition-colors">Instagram</p>
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <p className="font-semibold text-[#E5E5E5] hover:text-[#FF0000] transition-colors">YouTube</p>
              </a>
            </li>
          </ul>
          ...
          <ul className="flex flex-col items-end gap-1 w-full">
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <p className="font-semibold text-[#E5E5E5] hover:text-[#FF0000] transition-colors">Unsplash</p>
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <p className="font-semibold text-[#E5E5E5] hover:text-[#FF0000] transition-colors">TikTok</p>
              </a>
            </li>
          </ul>
        </div>
